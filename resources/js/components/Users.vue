       ...
       <div class="row mt-5" v-if="$gate.isAdminOrAuthor()">
        ...
        aria-labelledby="addNewLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <form @submit.prevent="editmode ? upateUser() : createUser()">
                ...
                <div class="modal-footer">
                    ...
                    <button v-show="editmode" type="sunbit" class="btn btn-success">Update</button>
                    <button v-show="!editmode" type="sunbit" class="btn btn-primary">Create</button>
                ...
                swal({
                        ...
                        confirmButtonText: 'Yes, delete it!'
                                ...
                                this.form.delete('api/user/'+id).then(()=>{
                                    ...
                                    swal("Failled!","There was something wrong.","warning")
                                });
                            }
                        })
            },
